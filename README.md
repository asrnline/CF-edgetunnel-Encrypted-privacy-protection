# edgetunnel Encrypted-privacy-protection,支持个人加密256位加密协议
...
### 免责
1. 作为本项目的 **二次开发作者**（以下简称“作者”），我 **AsrnLine** 强调本项目仅应用于合法、道德和教育目的。
...
| GO2SOCKS5  | `*.ip111.cn`,`*google.com` |❌| 设置`SOCKS5`变量之后，可设置强制使用socks5访问名单(`*`可作为通配符，`换行`作多元素间隔) ||
...
| URL | `https://google.com` |❌| 主页反代伪装(支持多url, url之间使用`,`或`换行`作间隔, 乱设容易触发反诈) |  |
